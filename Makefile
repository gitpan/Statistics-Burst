# This Makefile is for the Statistics::Burst extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Statistics/Burst.pm]
#     AUTHOR => q[A. U. Thor <a.u.thor@a.galaxy.far.far.away>]
#     NAME => q[Statistics::Burst]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Statistics/Burst.pm]
...
AR_STATIC_ARGS = cr
DIRFILESEP = /
NAME = Statistics::Burst
NAME_SYM = Statistics_Burst
VERSION = 0.01
...
FULLEXT = Statistics/Burst
BASEEXT = Burst
PARENT_NAME = Statistics
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Statistics/Burst.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Statistics/Burst.pm
...
TO_INST_PM = lib/Statistics/Burst.pm

PM_TO_BLIB = lib/Statistics/Burst.pm \
...
DISTNAME = Statistics-Burst
DISTVNAME = Statistics-Burst-0.01
...
manifypods : pure_all  \
	lib/Statistics/Burst.pm \
	lib/Statistics/Burst.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/Statistics/Burst.pm $(INST_MAN3DIR)/Statistics::Burst.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Statistics/Burst.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Statistics-Burst' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.01' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Statistics/Burst.pm' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Statistics/Burst.pm blib/lib/Statistics/Burst.pm 
	$(NOECHO) $(TOUCH) $@
